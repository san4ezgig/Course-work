...
\begin{center}
	...
	\begin{flushleft}
		...
		вероятности и числовые характеристики системы. Построена матрица переходных вероятностей. Найдено
...
\section*{Abstract}
	\begin{flushleft}
		...
		model and investigate its behavior in various cases. The transition probabilities and numerical characteristics
